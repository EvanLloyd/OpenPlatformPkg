...
#define PCI_HB0RB0_PCI_BASE        (0xb0070000)
#define PCI_HB0RB1_PCI_BASE        (0xb0080000)
#define PCI_HB0RB2_PCI_BASE        (0xb0090000)
#define PCI_HB0RB3_PCI_BASE        (0xb00a0000)
#define PCI_HB1RB0_PCI_BASE         (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB0_PCI_BASE)
#define PCI_HB1RB1_PCI_BASE         (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB1_PCI_BASE)
#define PCI_HB1RB2_PCI_BASE         (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB2_PCI_BASE)
#define PCI_HB1RB3_PCI_BASE         (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB3_PCI_BASE)
...
#define PCI_HB1RB2_ECAM_BASE      (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB2_ECAM_BASE)
#define PCI_HB1RB2_ECAM_SIZE       PCI_HB0RB2_ECAM_SIZE
#define PCI_HB1RB3_ECAM_BASE      (FixedPcdGet64 (PcdHb1BaseAddress) + PCI_HB0RB3_ECAM_BASE)
#define PCI_HB1RB3_ECAM_SIZE       PCI_HB0RB3_ECAM_SIZE
